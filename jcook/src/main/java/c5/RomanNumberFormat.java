...
public class RomanNumberFormat extends Format {
	...
	final static char A2R[][] = { { 0, 'M' }, { 0, 'C', 'D', 'M' }, { 0, 'X', 'L', 'C' }, { 0, 'I', 'V', 'X' }, };
	...
	final static R2A[] R2A = { new R2A('M', 1000), new R2A('D', 500), new R2A('C', 100), new R2A('L', 50),
			new R2A('X', 10), new R2A('V', 5), new R2A('I', 1), };
