...
public class LinkList<T> implements List<T> {
	...
	/**
	 * Construct a LinkList given another Collection. This method is recommended
	 * by the general contract of List.
	 */
	...
	/**
	 * Set the List (back) to its initial state. Any references held will be
	 * discarded.
	 */
	public void clear() {
	...
	/**
	 * Add one object to the end of the list. Update the "next" reference in the
	 * previous end, to refer to the new node. Update "last" to refer to the new
	 * node.
	 */
