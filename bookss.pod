...
=head1 Computer System - A Programmer's Perspective
csapp
...
=head1 Mastering Regular Expressions
mre
...
=head1 Structure and Interpretation of Computer Programs
sicp
...
=head1 Operating System Concepts
osc
...
=head1 The C Programming Language
tcpl
...
=head1 Data Structure & Their Algorithms
dsta
...
=head1 Mastering Algorithm with C
mac
...
=head1 Beginning Linux Programming
blp
...
=head1 The Unix Programming Environment
tupe
...
=head1 Mastering Algorithms with Perl
map
...
=head1 Computer Organization and Architecture
coa
...
=head1 Design Patterns Elements of Reusable Object-Oriented Software
dp
